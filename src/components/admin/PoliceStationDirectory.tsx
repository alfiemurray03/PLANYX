      ...
      <CardContent className="min-w-0 space-y-4 p-4 sm:p-5">
        <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1 max-w-3xl text-xs leading-5 text-slate-600 dark:text-slate-300">Station data is now loaded through the protected Sousa Murray Planeia server rather than directly from the browser. Always verify public-access arrangements on the force website.</p>
          </div>
