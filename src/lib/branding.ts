...
const DEFAULTS: Branding = {
  platform_name: 'Sousa Murray Planeia',
  platform_tagline: 'Personalised plans, built step by step.',
  platform_description: 'Build destination, itinerary, experience, accessibility and practical travel plans with guided Sousa Murray Planeia tools and planning support.',
  platform_url: 'https://sousamurrayplaneia.jagroupservices.co.uk',
  platform_logo_url: '',
