...
export default function AdminAuthorityReportingPage() {
  ...
  async function saveReport(): Promise<void> {
    ...
    try {
      const response = await fetch('/api/admin/authority-reports', {
        ...
        body: JSON.stringify({ ...form, action: form.id ? 'update' : 'create', form_payload: { guidance_version: '2026-07-24', prepared_in: 'Planyx Authority Reporting Centre' } }),
      });
  ...
  return (
    <>
      <Helmet><title>Authority Reporting Centre - Planyx Admin Centre</title><meta name="robots" content="noindex, nofollow" /></Helmet>
