...
export default function PlansPage() {
  return (
    <>
      <Helmet>
        <title>Standard & Business Plans | Sousa Murray Planeia</title>
        <meta name="description" content="Compare Sousa Murray Planeia Standard Plans for individuals and separately billed Business Plans for organisations." />
        <link rel="canonical" href="https://sousamurrayplaneia.jagroupservices.co.uk/plans" />
      </Helmet>
      <main className="min-h-screen bg-background">
        <section className="border-b border-border bg-gradient-to-b from-primary/10 to-background px-4 py-20 text-center">
          <p className="text-sm font-bold uppercase tracking-wider text-primary">Sousa Murray Planeia subscriptions</p>
