...
export async function onRequestGet({ request, env }) {
  ...
  return new Response(`<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Partner Gallery Manager | Sousa Murray Planeia Admin</title><meta name="robots" content="noindex,nofollow"><link rel="stylesheet" href="/assets/admin-partner-galleries.css?v=1"></head><body><div class="pg-admin"><header class="pg-admin__header"><a href="/admin/dashboard" class="pg-admin__brand"><span class="brand-wordmark" style="font-weight:800;letter-spacing:-.02em;color:inherit">Sousa Murray Planeia</span><span>ADMIN CENTRE</span></a><div class="pg-admin__identity"><span>Signed in as</span><strong>${escapeHtml(name)}</strong></div></header><main id="partner-gallery-app" aria-live="polite"><div class="pg-loading"><span></span><p>Loading Partner Gallery Manager…</p></div></main><footer class="pg-admin__footer"><a href="/admin/dashboard">Back to Admin Dashboard</a><span>Headout · GetYourGuide · Admin-only access</span></footer></div><script src="/assets/admin-partner-galleries.js?v=1" defer></script></body></html>`, {
    status: 200,
