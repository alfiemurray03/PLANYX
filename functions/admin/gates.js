...
export async function onRequestGet({ request, env }) {
  ...
  return new Response(`<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Gate Control Centre | Planyx Admin</title><meta name="robots" content="noindex,nofollow"><link rel="icon" href="/assets/brand/planyx-icon.png?v=1"><link rel="stylesheet" href="/assets/admin-gates.css?v=1"></head><body><div class="gate-admin"><header class="gate-admin__header"><a href="/admin/dashboard" class="gate-admin__brand"><img src="/assets/brand/planyx-logo.svg?v=1" alt="Planyx"><span>ADMIN CENTRE</span></a><div class="gate-admin__identity"><span>Signed in as</span><strong>${escapeHtml(name)}</strong></div></header><main id="gate-control-app" aria-live="polite"><div class="gate-admin__loading"><span></span><p>Loading Gate Control Centre…</p></div></main><footer class="gate-admin__footer"><a href="/admin/site-settings">Site Status &amp; Settings</a><span>Launch Gate · Maintenance Gate · Admin-only access</span></footer></div><script src="/assets/admin-gates.js?v=1" defer></script></body></html>`, {
    status: 200,
