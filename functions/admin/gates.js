...
async function authorised(DB, identity, env) {
  ...
  return permissions.includes("*") || permissions.includes("manage_system_settings") || permissions.includes("manage_site_status") || permissions.includes("manage_content")
...
export async function onRequestGet({ request, env }) {
  ...
  return new Response(`<!doctype html><html lang="en-GB"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Gate Control Centre | Sousa Murray Planeia Admin</title><meta name="robots" content="noindex,nofollow"><link rel="stylesheet" href="/assets/admin-gates.css?v=1"></head><body><div class="gate-admin"><header class="gate-admin__header"><a href="/admin/dashboard" class="gate-admin__brand"><span class="brand-wordmark" style="font-weight:800;letter-spacing:-.02em;color:inherit">Sousa Murray Planeia</span><span>ADMIN CENTRE</span></a><div class="gate-admin__identity"><span>Signed in as</span><strong>${escapeHtml(name)}</strong></div></header><main id="gate-control-app" aria-live="polite"><div class="gate-admin__loading"><span></span><p>Loading Gate Control Centre…</p></div></main><footer class="gate-admin__footer"><a href="/admin/site-settings">Site Status &amp; Settings</a><span>Launch Gate · Maintenance Gate · Admin-only access</span></footer></div><script src="/assets/admin-gates.js?v=1" defer></script></body></html>`, {
    status: 200,
