(() => {
  ...
  fetch('/api/age-verification-assistant', { credentials: 'include', cache: 'no-store', headers: { Accept: 'application/json' } })
    ...
    .then(({ response, payload }) => {
      ...
      for (const label of Array.isArray(payload.suggestions) && payload.suggestions.length ? payload.suggestions : safeSuggestions) {
